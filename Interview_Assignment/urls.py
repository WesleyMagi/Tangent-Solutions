...
from .views import HomeTemplateView, LoginView, WhoAmI, LogoutViewEx, EmployeeView,FindAUnicornView,CompanyStatsView
...
urlpatterns = [
    ...
    path('find_a_unicorn/', FindAUnicornView.as_view(),name='find_a_unicorn'),
